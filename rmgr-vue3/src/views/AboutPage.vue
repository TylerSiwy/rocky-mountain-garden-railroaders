        ...
        <v-card class="w-100 text-surface" color="transparent" flat>
          <v-row class="mb-6">
            <v-col class="pe-md-6 mb-6 mb-md-0" cols="12" md="6">
              ...
              <div
                v-for="(item, index) in communityEngagementList"
                :key="index"
            ...
            <v-col cols="12" md="5">
              ...
              <p class="mb-4 opacity-90">
                One of the most anticipated events is our club
                <span class="text-secondary font-weight-medium">Garden Tour</span>, which is open to
                anyone interested. It’s usually held in July.
              </p>
              <p class="opacity-90">
                Members visit a series of club members' layouts, offering a chance to exchange
                ideas, showcase progress, and enjoy a shared passion. The day often wraps up with a
                friendly BBQ.
              </p>
            </v-col>
          </v-row>
          ...
          <v-row>
            ...
            <v-col cols="12" md="5">
              ...
              <div
                v-for="(item, index) in aimsObjectivesList"
                :key="index"
                class="d-flex align-start mb-2"
              >
                <span class="text-secondary me-2 font-weight-bold mt-n1">•</span>
